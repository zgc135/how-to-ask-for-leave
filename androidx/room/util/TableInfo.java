...
public class TableInfo {
    ...
    public boolean equals(Object obj) {
        ...
        if (str == null ? tableInfo.f2name != null : !str.equals(tableInfo.f2name)) {
            return false;
        }
    ...
    public String toString() {
        return "TableInfo{name='" + this.f2name + '\'' + ", columns=" + this.columns + ", foreignKeys=" + this.foreignKeys + ", indices=" + this.indices + '}';
    }
    ...
    public static class Column {
        ...
        public boolean equals(Object obj) {
            ...
            if (!this.f3name.equals(column.f3name) || this.notNull != column.notNull) {
                return false;
            }
        ...
        public int hashCode() {
            return (((((this.f3name.hashCode() * 31) + this.affinity) * 31) + (this.notNull ? 1231 : 1237)) * 31) + this.primaryKeyPosition;
        }

        public String toString() {
            return "Column{name='" + this.f3name + '\'' + ", type='" + this.type + '\'' + ", affinity='" + this.affinity + '\'' + ", notNull=" + this.notNull + ", primaryKeyPosition=" + this.primaryKeyPosition + ", defaultValue='" + this.defaultValue + '\'' + '}';
        }
    }
    ...
    public static class Index {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f4name.startsWith(DEFAULT_PREFIX)) {
                return index.f4name.startsWith(DEFAULT_PREFIX);
            }
            return this.f4name.equals(index.f4name);
        }
        ...
        public int hashCode() {
            ...
            if (this.f4name.startsWith(DEFAULT_PREFIX)) {
                ...
                i = this.f4name.hashCode();
            }
            return (((i * 31) + (this.unique ? 1 : 0)) * 31) + this.columns.hashCode();
        }

        public String toString() {
            return "Index{name='" + this.f4name + '\'' + ", unique=" + this.unique + ", columns=" + this.columns + '}';
        }
    }
}
