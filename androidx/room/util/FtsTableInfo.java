...
public class FtsTableInfo {
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.f1name;
        if (str == null ? ftsTableInfo.f1name != null : !str.equals(ftsTableInfo.f1name)) {
            return false;
        }
    ...
    public String toString() {
        return "FtsTableInfo{name='" + this.f1name + '\'' + ", columns=" + this.columns + ", options=" + this.options + '}';
    }
}
